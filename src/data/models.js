export const models = {
  ...
  sample_spec: {
    max_tokens:
      "set to max_output_tokens if provider specifies it. IF not set to max_tokens provider specifies",
    max_input_tokens:
      "max input tokens, if the provider specifies it. if not default to max_tokens",
    max_output_tokens:
