...
export const stepDescriptionsMap = {
  crawl: combineInfo({
    ...
    args: {
      query: {
        description:
          "A description of links to look for. Should be specific, and should include exclusions.",
        format: "string",
        example:
          "Look for links to user profile pages. Ignore navigation links, links to posts, and advertisements.",
        required: true,
      },
      css: {
        description:
          "A CSS selector, if present we will look only in this section",
        format: "string",
        required: false,
      },
    },
  ...
  const: combineInfo({
    name: "const",
    description:
      "Add a constant item, typically used to initialize the starting URL",
    args: {
      items: {
  ...
  fetch: combineInfo({
    ...
    args: {
      ...
      css: {
        description:
          "A CSS selector that narrows which part of the page to return",
        format: "string",
        required: false,
      },
    },
  ...
  schema: combineInfo({
    ...
    args: {
      schema: {
        ...
        format: "object",
        example:
          '{"title": "article title", "authors": ["list of authors..."]}',
        required: true,
      },
    },
  }),
